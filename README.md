...
- `madcalc_desktop` - aplikacja Flutter dla macOS, Windows i Androida
...
madcalc_desktop/   Flutter dla macOS, Windows i Androida
```
...
- `madcalc_desktop/build/app/outputs/flutter-apk/app-release.apk`
